...
(() => {
  ...
  // .wrangler/tmp/bundle-q4qLhX/checked-fetch.js
...
`
  ...
  // ../../.nodebrew/node/v20.12.2/lib/node_modules/wrangler/templates/modules-watch-stub.js
  ...
  // ../../.nodebrew/node/v20.12.2/lib/node_modules/wrangler/templates/middleware/common.ts
  ...
  // ../../.nodebrew/node/v20.12.2/lib/node_modules/wrangler/templates/middleware/loader-sw.ts
  ...
  // ../../.nodebrew/node/v20.12.2/lib/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
  ...
  // ../../.nodebrew/node/v20.12.2/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
  ...
  // .wrangler/tmp/bundle-q4qLhX/middleware-insertion-facade.js
  ...
  async function handleEvent(event) {
    ...
    try {
      ...
      return await (0, import_kv_asset_handler.getAssetFromKV)(event, options);
    } catch (e) {
      if (!DEBUG) {
        try {
          let notFoundResponse = await (0, import_kv_asset_handler.getAssetFromKV)(event, {
            mapRequestToAsset: /* @__PURE__ */ __name((req) => new Request(`${new URL(req.url).origin}/404.html`, req), "mapRequestToAsset")
          });
